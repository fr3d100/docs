...
<Columns cols={2}>
  ...
  <Card title="Company information" icon="building-circle-check" iconType="solid">
    Get all the up to date contact's current Company information such as Name, Domain, HQ Location, Industry, Number of employee, ...
  </Card>
</Columns>
...
<Note>
  **Lead Finder Search API is an async API.**\
  Meaning you will have to submit your contacts to enruch then wait a few minutes to get the enriched data on your provided webhook or fecth the enriched data with the according endpoint.
</Note>
...
<Note>
  **BetterContact also verifies catch_all email**<Tooltip tip="">.</Tooltip>
